...
public class ImageEntityServiceImpl implements ImageEntityService {
    ...
    private final ImageEntityService self;

    @Autowired
    public ImageEntityServiceImpl(ImageRepository imageRepository,
                                  FileStorageService fileStorageService,
                                  @Lazy ImageEntityService self) {
    ...
    public FileUploadResponse uploadImage(MultipartFile file, int quality, boolean fallbackToJpeg) throws IOException {
        ...
        // Save the image entity using the proxy
        Image savedImage = self.saveImage ( fileUrl );
