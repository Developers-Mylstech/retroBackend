...
public class JobPostServiceImpl implements JobPostService {
    ...
    private static final String JOB_POST = "JobPost";
    ...
    public JobPostResponse updateJobPost(Long id, JobPostRequest request) {
        JobPost jobPost = jobPostRepository.findById ( id )
                .orElseThrow ( () -> new ResourceNotFoundException ( JOB_POST, "id", id ) );
    ...
    public JobPostResponse setJobPostImage(Long jobPostId, Long imageId) {
        ...
        JobPost jobPost = jobPostRepository.findById ( jobPostId )
                .orElseThrow ( () -> new ResourceNotFoundException ( JOB_POST, "id", jobPostId ) );
