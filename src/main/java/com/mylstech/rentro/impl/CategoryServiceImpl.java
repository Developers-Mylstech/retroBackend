...
import com.mylstech.rentro.exception.EntityAssociationException;
...
public class CategoryServiceImpl implements CategoryService {
        ...
        if ( request.getParentCategoryId ( ) != null ) {
            ...
            while (current != null) {
                if ( current.getCategoryId ( ).equals ( id ) ) {
                    throw new IllegalArgumentException ( "Circular reference detected: a category cannot have itself as an ancestor" );
                }
    ...
    public void deleteCategory(Long id) {
        ...
        if ( category.getSubCategories ( ) != null && ! category.getSubCategories ( ).isEmpty ( ) ) {
            throw new EntityAssociationException ( "Cannot delete category with subcategories. Found " +
        ...
        if ( productsWithCategory != null && ! productsWithCategory.isEmpty ( ) ) {
            throw new EntityAssociationException ( "Cannot delete category with associated products. Found " +
        ...
        if ( productsWithSubCategory != null && ! productsWithSubCategory.isEmpty ( ) ) {
            throw new EntityAssociationException ( "Cannot delete category with associated products as subcategory. Found " +
